...
/*        cbHappy.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
    ...
    class FreepHandler extends DefaultHandler {
        ...
        public void startElement(String uri, String localName, String qName, Attributes attributes) throws SAXException {
            ...
            Log.d("StartElement", "startElement: " + qName + "localname:" + localName + "attributes" + attributes);

            if(qName.equals("title")) {
                inTitle = true;
            }

            //can access attributes of an element
            //attributes....
        }
        ...
        public void characters(char[] ch, int start, int length) throws SAXException {
            ...
            //if we are in a title element,
            //add the characters to our arraylist
            if(inTitle) {
                title.add(s);
            }
        }
